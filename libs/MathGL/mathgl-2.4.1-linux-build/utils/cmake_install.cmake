# Install script for directory: /home/don_vanchos/CAPSYS/libs/MathGL/mathgl-2.4.1/utils
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/don_vanchos/CAPSYS/libs/MathGL/mathgl-2.4.1-linux-build/utils/mglconv")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/mglconv" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mglconv")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/mglconv"
...
file(INSTALL DESTINATION "/usr/local/share/mathgl" TYPE EXECUTABLE FILES "/home/don_vanchos/CAPSYS/libs/MathGL/mathgl-2.4.1-linux-build/utils/mgl.cgi")
  if(EXISTS "$ENV{DESTDIR}/usr/local/share/mathgl/mgl.cgi" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/share/mathgl/mgl.cgi")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/share/mathgl/mgl.cgi"
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/don_vanchos/CAPSYS/libs/MathGL/mathgl-2.4.1-linux-build/utils/mglview")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/mglview" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mglview")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/mglview"
